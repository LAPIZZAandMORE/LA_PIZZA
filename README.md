...
const questions = [
    ...
    { q: "پیتزایەک بۆ ئەڵێت من شاورمەم", a: "چونکە لول دراوە", options: ["درۆزنە", "چونکە لول دراوە", "پیتزا قسە ناکات", "چونکە شاورمەیە"] },
    { q: "پیتزا گەر عاشق بێ عاشقی کێ ئەبێ؟", a: "شاورمەیەکی باڵا بەرز", options: ["برگر", "کەپلی هەیە", "شاورمەیەکی باڵا بەرز", "عاشق نابێ"] },
    { q: "پینزا لە چی پێکدێ", a: "هیچیان", options: ["هیچیان", "هەردوو ئەوانی سەرەوە", "سەزەوات", "پەنیر"] },
    { q: "پیتزا لە سەدەی چەند دروست بووە؟", a: "پپرونی", options: ["چوزانمم", "١٥-١٦", "١٦-١٧", "١٨-١٩"] }
];
...
const correctFeedbacks = [
    ...
    "زۆر شەرمنە!", 
    "بە دڵنیاییەوە", 
    "زیرەکی دوای تۆ درۆیە", 
    "کرەشی لێێ هەیە.", 
    "نوسراوە پینزا نەک پیتزا بەڕێززز!", 
    "وەڵا عەفیە"
];
