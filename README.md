...
<script>
const questions = [
    { q: "کدام نوع پیتزا کلاسیک است؟", a: "مارگاریتا", options: ["مارگاریتا", "پپرونی", "سبزیجات", "کاپریچوزا"] },
    { q: "پیتزا پپرونی شامل چه موادی است؟", a: "پپرونی", options: ["پپرونی", "مرغ", "سبزیجات", "قارچ"] },
    { q: "سس کلاسیک پیتزا چیست؟", a: "گوجه فرنگی", options: ["سس سفید", "سس گوجه فرنگی", "سس باربیکیو", "سس پستو"] },
    { q: "پیتزا مارگاریتا شامل چه چیزهایی است؟", a: "پنیر و گوجه", options: ["گوشت و پنیر", "پنیر و گوجه", "سبزیجات", "مرغ و قارچ"] },
    { q: "کدام پنیر معمولاً روی پیتزا استفاده می‌شود؟", a: "موزارلا", options: ["چدار", "موزارلا", "پارمسان", "پنیر آبی"] },
    { q: "کدام کشور مبدأ پیتزا است؟", a: "ایتالیا", options: ["فرانسه", "ایتالیا", "آمریکا", "مکزیک"] },
...
const correctFeedbacks = [
    "عالی! مارگاریتا کلاسیک است.", 
    "درست است! پپرونی شامل گوشت خوشمزه است.", 
    "آفرین! سس کلاسیک گوجه فرنگی است.", 
    "درست! مارگاریتا شامل پنیر و گوجه است.", 
    "موزارلا، درست است!", 
    "ایتالیا مبدأ پیتزا است، عالی!", 
...
const wrongFeedbacks = [
    "نه! پاسخ درست مارگاریتا است.", 
    "پاسخ اشتباه! درستش پپرونی است.", 
    "اشتباه! سس کلاسیک گوجه فرنگی است.", 
    "نه! پاسخ درست پنیر و گوجه است.", 
    "اشتباه! پاسخ درست موزارلا است.", 
    "نه! مبدأ پیتزا ایتالیا است.", 
